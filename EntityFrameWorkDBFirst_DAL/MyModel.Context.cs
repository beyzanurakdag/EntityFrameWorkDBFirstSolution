...
namespace EntityFrameWorkDBFirst_DAL
{
    ...
    public partial class NORTHWNDEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> sp_KategoriGuncelle(Nullable<int> id, string kategorininYeniAdi, string kategoriYeniAciklamasi, byte[] yeniResmi)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            var kategorininYeniAdiParameter = kategorininYeniAdi != null ?
                new ObjectParameter("kategorininYeniAdi", kategorininYeniAdi) :
                new ObjectParameter("kategorininYeniAdi", typeof(string));
    
            var kategoriYeniAciklamasiParameter = kategoriYeniAciklamasi != null ?
                new ObjectParameter("KategoriYeniAciklamasi", kategoriYeniAciklamasi) :
                new ObjectParameter("KategoriYeniAciklamasi", typeof(string));
    
            var yeniResmiParameter = yeniResmi != null ?
                new ObjectParameter("YeniResmi", yeniResmi) :
                new ObjectParameter("YeniResmi", typeof(byte[]));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("sp_KategoriGuncelle", idParameter, kategorininYeniAdiParameter, kategoriYeniAciklamasiParameter, yeniResmiParameter);
        }
